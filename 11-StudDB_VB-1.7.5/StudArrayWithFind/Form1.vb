Public Class Form1
    ...
    Private Sub btnAddStud_Click(sender As Object, e As EventArgs) Handles btnAddStud.Click
        ...
        For i = 0 To studentCount - 2
            If students(studentCount - 1).firstname = students(i).firstname And
                students(studentCount - 1).lastname = students(i).lastname AndAlso
                students(studentCount - 1).DOB = students(i).DOB Then
                MsgBox("This student already exists in database", MsgBoxStyle.Exclamation, "Existing Student")
                Exit Sub
            End If
        Next
